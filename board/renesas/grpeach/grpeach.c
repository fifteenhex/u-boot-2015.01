...
int board_early_init_f(void)
{
	...
	pfc_set_pin_function(10, 5, ALT4, 0, 0); /* + P10_5 = ET_TXD1 */
	pfc_set_pin_function(10, 6, ALT4, 0, 0); /* + P10_6 = ET_TXD2 */
	pfc_set_pin_function(10, 7, ALT4, 0, 0); /* + P10_7 = ET_TXD3 */
	pfc_set_pin_function(10, 8, ALT4, 0, 0); /* + P10_8 = ET_RXD0 */
	pfc_set_pin_function(10, 9, ALT4, 0, 0); /* + P10_9 = ET_RXD1 */
